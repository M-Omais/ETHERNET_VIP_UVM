...
vsim -sv_lib frame -classdebug -uvmcontrol=all -voptargs=+acc +UVM_NO_RELNOTES +UVM_NO_MSG=PHASESEQ +UVM_NO_MSG=PH_READY_TO_END  +UVM_TESTNAME=xgmii_test work.top -do "run 0"
